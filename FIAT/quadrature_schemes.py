...
from FIAT.quadrature import (
    QuadratureRule,
    make_quadrature,
    make_tensor_product_quadrature,
)
...
def create_quadrature(ref_el, degree, scheme="default"):
    ...
    if ref_el.get_shape() == TENSORPRODUCT:
        ...
        quad_rules = [
            create_quadrature(c, d, scheme) for c, d in zip(ref_el.cells, degree)
        ]
...
def _kmv_lump_scheme(ref_el, degree):
    ...
    if degree == 1:
        ...
        if sd == 2:
            ...
            # x.extend(
            #    [
            #        (0.6228390306071099, 0.1885804846964451, 0.1885804846964451),
            #        (0.1885804846964451, 0.6228390306071099, 0.1885804846964451),
            #        (0.1885804846964451, 0.1885804846964451, 0.6228390306071099),
            #        (0.0, 0.1885804846964451, 0.1885804846964451),
            #        (0.0, 0.6228390306071099, 0.1885804846964451),
            #        (0.0, 0.1885804846964451, 0.6228390306071099),
            #        (0.1885804846964451, 0.0, 0.1885804846964451),
            #        (0.6228390306071099, 0.0, 0.1885804846964451),
            #        (0.1885804846964451, 0.0, 0.6228390306071099),
            #        (0.1885804846964451, 0.1885804846964451, 0.0),
            #        (0.6228390306071099, 0.1885804846964451, 0.0),
            #        (0.1885804846964451, 0.6228390306071099, 0.0),
            #    ]
            # )
            ...
            # w[10:22] = 0.0089577749685404578494640759345202
        ...
        if sd == 2:
            ...
            x.extend(
                [
                    (0.0, 0.6857896575819671, 0.31421034241803286),
                    (0.0, 0.31421034241803286, 0.6857896575819671),
                    (0.6857896575819671, 0.0, 0.31421034241803286),
                    (0.6857896575819671, 0.31421034241803286, 0.0),
                    (0.0, 0.0, 0.6857896575819671),
                    (0.0, 0.0, 0.31421034241803286),
                    (0.0, 0.31421034241803286, 0.0),
                    (0.0, 0.6857896575819671, 0.0),
                    (0.31421034241803286, 0.0, 0.6857896575819671),
                    (0.31421034241803286, 0.0, 0.0),
                    (0.6857896575819671, 0.0, 0.0),
                    (0.31421034241803286, 0.6857896575819671, 0.0),
                ]
            )  # 12 points on edges of facets (0-->1-->2)

            # x.extend(
            #    [
            #        (0.0, 0.6858, 0.31420),  # 1
            #        (0.0, 0.3142, 0.6858),  # 2
            #        (0.6858, 0.0, 0.3142),  # 3
            #        (0.6858, 0.3142, 0.0),  # 4
            #        (0.0, 0.0, 0.6858),  # 5
...
def _tetrahedron_scheme(degree):
    ...
    if degree == 0 or degree == 1:
        ...
        x = array([[a, b, b], [b, a, b], [b, b, a], [b, b, b]])
