...
def test_TFE_2Dx1D_scalar_quad():
    ...
    for da, db, dc in [[(0,), (0,), (0,)], [(1,), (0,), (0,)], [(0,), (1,), (0,)], [(0,), (0,), (1,)]]:
        ...
        nose.tools.assert_almost_equal(tab[dd][3][0], tA[da][0][0]*tB[db][1][0]*tC[dc][1][0])
        nose.tools.assert_almost_equal(tab[dd][4][0], tA[da][1][0]*tB[db][0][0]*tC[dc][0][0])
        nose.tools.assert_almost_equal(tab[dd][5][0], tA[da][1][0]*tB[db][0][0]*tC[dc][1][0])
        nose.tools.assert_almost_equal(tab[dd][6][0], tA[da][1][0]*tB[db][1][0]*tC[dc][0][0])
        nose.tools.assert_almost_equal(tab[dd][7][0], tA[da][1][0]*tB[db][1][0]*tC[dc][1][0])
...
def test_TFE_2Dx1D_scalar_triangle_hdiv():
    ...
    for da, db in [[(0, 0), (0,)], [(1, 0), (0,)], [(0, 1), (0,)], [(0, 0), (1,)]]:
        ...
        nose.tools.assert_almost_equal(tab[dc][3][0][0], 0.0)
        nose.tools.assert_almost_equal(tab[dc][4][0][0], 0.0)
        nose.tools.assert_almost_equal(tab[dc][5][0][0], 0.0)
        nose.tools.assert_almost_equal(tab[dc][6][0][0], 0.0)
        nose.tools.assert_almost_equal(tab[dc][7][0][0], 0.0)
        nose.tools.assert_almost_equal(tab[dc][8][0][0], 0.0)
        nose.tools.assert_almost_equal(tab[dc][0][1][0], 0.0)
        nose.tools.assert_almost_equal(tab[dc][1][1][0], 0.0)
        nose.tools.assert_almost_equal(tab[dc][2][1][0], 0.0)
        nose.tools.assert_almost_equal(tab[dc][3][1][0], 0.0)
        nose.tools.assert_almost_equal(tab[dc][4][1][0], 0.0)
        nose.tools.assert_almost_equal(tab[dc][5][1][0], 0.0)
        nose.tools.assert_almost_equal(tab[dc][6][1][0], 0.0)
        nose.tools.assert_almost_equal(tab[dc][7][1][0], 0.0)
        nose.tools.assert_almost_equal(tab[dc][8][1][0], 0.0)
        nose.tools.assert_almost_equal(tab[dc][0][2][0], tabA[da][0][0]*tabB[db][0][0])
        nose.tools.assert_almost_equal(tab[dc][1][2][0], tabA[da][0][0]*tabB[db][1][0])
        nose.tools.assert_almost_equal(tab[dc][2][2][0], tabA[da][0][0]*tabB[db][2][0])
        nose.tools.assert_almost_equal(tab[dc][3][2][0], tabA[da][1][0]*tabB[db][0][0])
        nose.tools.assert_almost_equal(tab[dc][4][2][0], tabA[da][1][0]*tabB[db][1][0])
        nose.tools.assert_almost_equal(tab[dc][5][2][0], tabA[da][1][0]*tabB[db][2][0])
        nose.tools.assert_almost_equal(tab[dc][6][2][0], tabA[da][2][0]*tabB[db][0][0])
        nose.tools.assert_almost_equal(tab[dc][7][2][0], tabA[da][2][0]*tabB[db][1][0])
...
def test_TFE_2Dx1D_scalar_triangle_hcurl():
    ...
    for da, db in [[(0, 0), (0,)], [(1, 0), (0,)], [(0, 1), (0,)], [(0, 0), (1,)]]:
        ...
        nose.tools.assert_almost_equal(tab[dc][0][2][0], tabA[da][0][0]*tabB[db][0][0])
        nose.tools.assert_almost_equal(tab[dc][1][2][0], tabA[da][0][0]*tabB[db][1][0])
        nose.tools.assert_almost_equal(tab[dc][2][2][0], tabA[da][1][0]*tabB[db][0][0])
        nose.tools.assert_almost_equal(tab[dc][3][2][0], tabA[da][1][0]*tabB[db][1][0])
        nose.tools.assert_almost_equal(tab[dc][4][2][0], tabA[da][2][0]*tabB[db][0][0])
...
def test_TFE_2Dx1D_scalar_quad_hdiv():
    ...
    for da, db, dc in [[(0,), (0,), (0,)], [(1,), (0,), (0,)], [(0,), (1,), (0,)], [(0,), (0,), (1,)]]:
        dd = da + db + dc
        nose.tools.assert_almost_equal(tab[dd][0][0][0], 0.0)
        nose.tools.assert_almost_equal(tab[dd][1][0][0], 0.0)
        nose.tools.assert_almost_equal(tab[dd][2][0][0], 0.0)
        nose.tools.assert_almost_equal(tab[dd][3][0][0], 0.0)
        nose.tools.assert_almost_equal(tab[dd][4][0][0], 0.0)
        nose.tools.assert_almost_equal(tab[dd][5][0][0], 0.0)
        nose.tools.assert_almost_equal(tab[dd][6][0][0], 0.0)
        nose.tools.assert_almost_equal(tab[dd][7][0][0], 0.0)
        nose.tools.assert_almost_equal(tab[dd][0][1][0], 0.0)
        nose.tools.assert_almost_equal(tab[dd][1][1][0], 0.0)
        nose.tools.assert_almost_equal(tab[dd][2][1][0], 0.0)
        nose.tools.assert_almost_equal(tab[dd][3][1][0], 0.0)
        nose.tools.assert_almost_equal(tab[dd][4][1][0], 0.0)
        nose.tools.assert_almost_equal(tab[dd][5][1][0], 0.0)
        nose.tools.assert_almost_equal(tab[dd][6][1][0], 0.0)
        nose.tools.assert_almost_equal(tab[dd][7][1][0], 0.0)
        nose.tools.assert_almost_equal(tab[dd][0][2][0], tA[da][0][0]*tB[db][0][0]*tC[dc][0][0])
        nose.tools.assert_almost_equal(tab[dd][1][2][0], tA[da][0][0]*tB[db][0][0]*tC[dc][1][0])
        nose.tools.assert_almost_equal(tab[dd][2][2][0], tA[da][0][0]*tB[db][1][0]*tC[dc][0][0])
        nose.tools.assert_almost_equal(tab[dd][3][2][0], tA[da][0][0]*tB[db][1][0]*tC[dc][1][0])
        nose.tools.assert_almost_equal(tab[dd][4][2][0], tA[da][1][0]*tB[db][0][0]*tC[dc][0][0])
        nose.tools.assert_almost_equal(tab[dd][5][2][0], tA[da][1][0]*tB[db][0][0]*tC[dc][1][0])
        nose.tools.assert_almost_equal(tab[dd][6][2][0], tA[da][1][0]*tB[db][1][0]*tC[dc][0][0])
        nose.tools.assert_almost_equal(tab[dd][7][2][0], tA[da][1][0]*tB[db][1][0]*tC[dc][1][0])
...
def test_TFE_2Dx1D_vector_triangle_hdiv_rotate():
    ...
    for da, db in [[(0, 0), (0,)], [(1, 0), (0,)], [(0, 1), (0,)], [(0, 0), (1,)]]:
        ...
        nose.tools.assert_almost_equal(tab[dc][3][0][0], tabA[da][1][1][0]*tabB[db][1][0])
        nose.tools.assert_almost_equal(tab[dc][4][0][0], tabA[da][2][1][0]*tabB[db][0][0])
        nose.tools.assert_almost_equal(tab[dc][5][0][0], tabA[da][2][1][0]*tabB[db][1][0])
        nose.tools.assert_almost_equal(tab[dc][0][1][0], -tabA[da][0][0][0]*tabB[db][0][0])
        nose.tools.assert_almost_equal(tab[dc][1][1][0], -tabA[da][0][0][0]*tabB[db][1][0])
        nose.tools.assert_almost_equal(tab[dc][2][1][0], -tabA[da][1][0][0]*tabB[db][0][0])
        nose.tools.assert_almost_equal(tab[dc][3][1][0], -tabA[da][1][0][0]*tabB[db][1][0])
        nose.tools.assert_almost_equal(tab[dc][4][1][0], -tabA[da][2][0][0]*tabB[db][0][0])
        nose.tools.assert_almost_equal(tab[dc][5][1][0], -tabA[da][2][0][0]*tabB[db][1][0])
        nose.tools.assert_almost_equal(tab[dc][0][2][0], 0.0)
        nose.tools.assert_almost_equal(tab[dc][1][2][0], 0.0)
        nose.tools.assert_almost_equal(tab[dc][2][2][0], 0.0)
        nose.tools.assert_almost_equal(tab[dc][3][2][0], 0.0)
...
def test_TFE_2Dx1D_vector_quad_hdiv():
    ...
    for da, db, dc in [[(0,), (0,), (0,)], [(1,), (0,), (0,)], [(0,), (1,), (0,)], [(0,), (0,), (1,)]]:
        dd = da + db + dc
        nose.tools.assert_almost_equal(tab[dd][0][0][0], -tA[da][0][0]*tB[db][0][0]*tE[dc][0][0])
        nose.tools.assert_almost_equal(tab[dd][1][0][0], -tA[da][0][0]*tB[db][0][0]*tE[dc][1][0])
        nose.tools.assert_almost_equal(tab[dd][2][0][0], -tA[da][1][0]*tB[db][0][0]*tE[dc][0][0])
        nose.tools.assert_almost_equal(tab[dd][3][0][0], -tA[da][1][0]*tB[db][0][0]*tE[dc][1][0])
        nose.tools.assert_almost_equal(tab[dd][4][0][0], 0.0)
        nose.tools.assert_almost_equal(tab[dd][5][0][0], 0.0)
        nose.tools.assert_almost_equal(tab[dd][6][0][0], 0.0)
        nose.tools.assert_almost_equal(tab[dd][7][0][0], 0.0)
        ...
        nose.tools.assert_almost_equal(tab[dd][2][1][0], 0.0)
        nose.tools.assert_almost_equal(tab[dd][3][1][0], 0.0)
        nose.tools.assert_almost_equal(tab[dd][4][1][0], tC[da][0][0]*tD[db][0][0]*tE[dc][0][0])
        nose.tools.assert_almost_equal(tab[dd][5][1][0], tC[da][0][0]*tD[db][0][0]*tE[dc][1][0])
        nose.tools.assert_almost_equal(tab[dd][6][1][0], tC[da][0][0]*tD[db][1][0]*tE[dc][0][0])
        nose.tools.assert_almost_equal(tab[dd][7][1][0], tC[da][0][0]*tD[db][1][0]*tE[dc][1][0])
        nose.tools.assert_almost_equal(tab[dd][0][2][0], 0.0)
        nose.tools.assert_almost_equal(tab[dd][1][2][0], 0.0)
        nose.tools.assert_almost_equal(tab[dd][2][2][0], 0.0)
        nose.tools.assert_almost_equal(tab[dd][3][2][0], 0.0)
        nose.tools.assert_almost_equal(tab[dd][4][2][0], 0.0)
        nose.tools.assert_almost_equal(tab[dd][5][2][0], 0.0)
        nose.tools.assert_almost_equal(tab[dd][6][2][0], 0.0)
        nose.tools.assert_almost_equal(tab[dd][7][2][0], 0.0)
...
def test_TFE_2Dx1D_vector_quad_hcurl():
    ...
    for da, db, dc in [[(0,), (0,), (0,)], [(1,), (0,), (0,)], [(0,), (1,), (0,)], [(0,), (0,), (1,)]]:
        ...
        nose.tools.assert_almost_equal(tab[dd][2][0][0], 0.0)
        nose.tools.assert_almost_equal(tab[dd][3][0][0], 0.0)
        nose.tools.assert_almost_equal(tab[dd][4][0][0], tC[da][0][0]*tD[db][0][0]*tE[dc][0][0])
        nose.tools.assert_almost_equal(tab[dd][5][0][0], tC[da][0][0]*tD[db][0][0]*tE[dc][1][0])
        nose.tools.assert_almost_equal(tab[dd][6][0][0], tC[da][0][0]*tD[db][1][0]*tE[dc][0][0])
        nose.tools.assert_almost_equal(tab[dd][7][0][0], tC[da][0][0]*tD[db][1][0]*tE[dc][1][0])
        nose.tools.assert_almost_equal(tab[dd][0][1][0], tA[da][0][0]*tB[db][0][0]*tE[dc][0][0])
        nose.tools.assert_almost_equal(tab[dd][1][1][0], tA[da][0][0]*tB[db][0][0]*tE[dc][1][0])
        nose.tools.assert_almost_equal(tab[dd][2][1][0], tA[da][1][0]*tB[db][0][0]*tE[dc][0][0])
        nose.tools.assert_almost_equal(tab[dd][3][1][0], tA[da][1][0]*tB[db][0][0]*tE[dc][1][0])
        nose.tools.assert_almost_equal(tab[dd][4][1][0], 0.0)
        nose.tools.assert_almost_equal(tab[dd][5][1][0], 0.0)
        nose.tools.assert_almost_equal(tab[dd][6][1][0], 0.0)
        nose.tools.assert_almost_equal(tab[dd][7][1][0], 0.0)
